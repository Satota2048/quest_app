...
1. ユーザーが作成したクエストを公表することができる機能、および公表されたクエストに他のユーザーが挑戦できる機能
1. クエストの難易度を計算するための指標および計算式の設定。受注・挑戦するための最低条件や想定される期間、個人的な得意・不得意によって変動するものであると予想される
1. ユーザーが今までに達成したクエストの経歴を公表できる機能およびその実績を他のユーザーが閲覧できる機能
1. ユーザーが他のユーザーにクエストの依頼を依頼し、受注することができる機能。これに関しては、報酬の内容・手段を依頼者側が設定することができ、受託者側の納得を確認ができる機能
1. ユーザーからの評価を現実に反映させることができる機能。今までの実績の内容によってはユーザーの人柄が証明できるものと考えるため。
